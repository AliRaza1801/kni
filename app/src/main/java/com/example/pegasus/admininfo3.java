...
import com.example.pegasus.Employee;
import com.example.pegasus.EmployeeAdapter;
import com.example.pegasus.MainActivity;
import com.example.pegasus.R;
import com.example.pegasus.admininfo;
import com.example.pegasus.admininfo2;

import java.util.ArrayList;
import java.util.List;

public class admininfo3 extends AppCompatActivity implements SearchView.OnQueryTextListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        b1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                startActivity(new Intent(admininfo3.this, admininfo2.class));
            }
        });
        showEmployeesFromDatabase();
    }
    private void showEmployeesFromDatabase() {
        Cursor cursorEmployees = mDatabase.rawQuery("SELECT * FROM pool order by name desc", null);
